...
<body>
    ...
    <header>
        <h1 class="text-center mt-2 mb-4"> Biblioteca Mágica</h1>
    </header>
    ...
    <section class="container ">
        ...
        <div class=" row mt-2">
            ...
            <div class="col-10">
                <h3 align="center " class="my-3">Entre em contato conosco</h3>
                <form class=" container test mb-3">
 
                    <div class="row mt-1 justify-content-between ">

                        <div class="col-4  ">
                            <label for="exampleInputEmail1" class="form-label">Nome</label>
                            <div class="input-group"><input type="text" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="row justify-content-between mt-1">
                        ...
                        <div class="col-4 ">
                            ...
                            <div class="input-group"><span class="input-group-text">@</span><input type="email"
                                    class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></div>

                        </div>
                        <div class="col-7">
                            <label for="exampleInputEmail1" class="form-label">WhatsApp (opcional)</label>
                            <div class="input-group"><span class="input-group-text"><img class="img-thumbnail"
                                        style="height: 25px; max-width:100% ; " src="img/Whatsapp-logo-pc-600x314.png"
                                        alt=""></span><input type="tel" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="row justify-content-around my-1">
                        ...
                        <div class="col-12 my-2 ">
                            <textarea style="width: 100%;" name="" id="" cols="115" rows="10" placeholder="Nos mande uma mensagem..." ></textarea>
                        
                            <div class=" form-check mt-1">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1"> Aceita receber notificações sobre o aplicativo?</label>
                            </div>
