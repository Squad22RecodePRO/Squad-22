...
<body>
    ...
    <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light border-bottom navbar-custom">
                <div class="container-fluid ">
                    <img class="logo logo-padrao" src="img/logo_escrita_semfundo.png" width="60px" href="index.html">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="itens nav-item px-3 ">
                                <a class="nav-link fs-5" href="ListarLivrosServelt">Catalogo</a>
                            </li>
                            <li class="itens nav-item px-3">
        ...
        <div class="Corpo1 col">

            <div class="rol primepiroTexto ">
                <h1> Biblioteca Mágica</h1>

                <h2> Um aplicativo gratuido para acompanhar o seu desempenho de leitura e manter os livros em dia </h2>
            </div>
            ...
            <section class="corpoPrincipal">
                ...
                <div class="divCorpo">
                    ...
                    <div class="divFoto">
                        ...
                        <img src="./img/celular_teste.png" width="280px">
                    ...
                    <div class="divTexto">
                        ...
                        <div class="miniTexto">
                            <p>Acompanhe seu desempenho de leitura, <br> organize seus livros, estabeleça metas e mais!
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                            <ul class="nav d-flex justify-content-center fs-5">
                                <li class="nav-link mx-3"><a href="index.html">Página inicial</a></li>
